...
const MetricsByTech = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/metrics/tech');
    ...
    return (
        <div className="p-4 border-1 border-dashed border-emerald-600 rounded-2xl">
            <h2 className="text-xl font-semibold mb-4">Metrics by Technology</h2>
            <div>
                <select
                    id="grouping"
                    value={grouping}
